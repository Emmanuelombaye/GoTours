        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-12 gap-16 relative">
          ...
          <div className="md:col-span-8">
            <div className="border-b border-slate-100 pb-8 flex items-center justify-between">
              ...
              <div className="w-14 h-14 rounded-full bg-slate-100 flex-shrink-0 border border-slate-50 overflow-hidden">
                <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=200&auto=format&fit=crop" alt="Host" className="w-full h-full object-cover" />
              </div>
            </div>
